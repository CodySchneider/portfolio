...
(function ($) {
	$.fn.sifr = function (prefs) {
		...
		this.each(function () {
			...
			fir = ele.addClass('sIFR-replaced').wrapInner('<span class="sIFR-alternate" style="position: relative; display:none;"></span>').children('.sIFR-alternate');
			alt = ele.append('<span class="sIFR-jquery" style="position: relative; ">' + $.trim(fir.text()) + '</span>').children('.sIFR-jquery');
